...
export class DashboardSidebarPage extends BasePage {
    ...
    private readonly createChallengeSubMenu = 'p.submenu-item:has-text("Create Challenge")';
    ...
    async navigateToCreateChallenge() {
        ...
        await this.page.waitForSelector(this.challengesMenu, { timeout: 15000 });
        await this.page.click(this.challengesMenu);
